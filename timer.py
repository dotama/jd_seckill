...
class Timer(object):
    ...
    def jd_time(self):
        ...
        ret = requests.get(url='https://api.m.jd.com/client.action?functionId=queryMaterialProducts&client=wh5',
                          headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.182 Safari/537.36'}).text
        js = json.loads(ret)
        # logger.info(".....", int(js["currentTime2"]))
